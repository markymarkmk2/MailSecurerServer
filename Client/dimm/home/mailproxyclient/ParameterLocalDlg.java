 ...
 */
public class ParameterLocalDlg extends javax.swing.JDialog
{
    MainFrame parent;
    boolean in_init;
    
    /** Creates new form ParameterRawDlg */
    public ParameterLocalDlg(MainFrame _parent)
    {
        super(_parent, true);
        parent = _parent;
    ...
    void get_params()
    {
        ...
        ArrayList<String> list = Main.get_prefs().get_prop_list();
        
        for (int i = 0; i < list.size(); i++)
        {
            CB_VAR.addItem( list.get(i) );
        }
    }
    ...
    void get_param()
    {
        ...
        String txt = this.CB_VAR.getEditor().getItem().toString();
        TXT_VAL.setText( Main.get_prop( txt ) );
        TXT_NEWVAL.setText( "" );
