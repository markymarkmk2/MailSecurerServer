...
public class SMTPConnection
{
     ...
     */
    private static final int SOCKET_TIMEOUT[] = {800, 1200, 1800, 2500, 3000, 6000, 10000}; //, 20000, 50000, 24300};
    /*
     * POP command RETR
     */
    private static final int SMTP_DATA = 1;
    /*
     * POP command LIST
     */
     ...
     * POP command QUIT
     */
    private static final int SMTP_QUIT = 3;
...
//    private SpamAssassin m_SA;						// Spam Assassin
   // private MoreLogger logger; 						// class from log4j by Jocca Jocaf
    ...
    {
     //   logger = new MoreLogger(SMTPConnection.class);
        m_host = host;
